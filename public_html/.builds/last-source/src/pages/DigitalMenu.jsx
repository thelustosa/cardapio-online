...
const DigitalMenu = ({ storeData, onUpdate, setIsDirty }) => {
  ...
  const defaultBanner = 'file:///C:/Users/lucas.coelho/.gemini/antigravity/brain/8dff10ed-fe5c-4dc9-89a8-f024d960b2f5/restaurant_banner_default_1776458618619.png';
  ...
  const handleSave = async () => {
    try {
      ...
      // Payload: Preserva dados existentes e atualiza apenas o banner
      const updateData = {
        ...storeData,
      ...
      <div className={styles.pageHeader}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          >
            {saveStatus === 'success' ? (
              <>
                <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <Save size={18} />
                  Salvo!
                </motion.span>
              </>
            ...
            <div className={styles.iphoneScreen}>
              ...
              <div className={styles.iphoneContent}>
                ...
                <div style={{
                  ...
                  <img
                    src={storeData?.logo || 'https://via.placeholder.com/80'}
                    style={{
                      position: 'absolute',
                      bottom: '-30px',
                      left: '50%',
